...
<div class="container">
        <h2 class="text-center pt-4" style="color:#0DE3FE;">TRANSFER MONEY</h2>
        <br>
            <div class="row">
                <div class="col">
                    ...
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered">
                        <thead>
                            <tr>
                            <th scope="col" class="text-center py-2" style="color:#FFFFFF;">ID</th>
                            <th scope="col" class="text-center py-2" style="color:#FFFFFF;">NAME</th>
                            <th scope="col" class="text-center py-2" style="color:#FFFFFF;">E-MAIL</th>
                            <th scope="col" class="text-center py-2" style="color:#FFFFFF;">BALANCE</th>
                            <th scope="col" class="text-center py-2" style="color:#FFFFFF;">TRANSACT</th>
                            </tr>
                        </thead>
                        <tbody>
                <?php 
